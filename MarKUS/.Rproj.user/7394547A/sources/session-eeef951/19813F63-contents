...
#'
#' @param obj data.frame with a "sample" column with the sample names, and a "merged_path" column, with the full names of the merged files
...
setMethod("count_kmers",
          ...
          function(obj,
            ...
            for (i in seq_len(nrow(obj))) {
              ...
              # Use bash process-substitution so jellyfish reads from stdin correctly
              inner_cmd <- sprintf(
